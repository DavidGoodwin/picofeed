...
class Rss10ParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10.xml'));
        $feed = $parser->execute();
        $this->assertCount(2, $feed->items);

        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_no_default_namespace.xml'));
        $feed = $parser->execute();
        $this->assertCount(3, $feed->items);

        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_prefixed.xml'));
        $feed = $parser->execute();
        $this->assertCount(1, $feed->items);

        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_empty_feed.xml'));
        $feed = $parser->execute();
        $this->assertSame(array(), $feed->items);

        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/heise.rdf'));
        $feed = $parser->execute();
    ...
    public function testFindFeedTitle()
    {
        ...
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_fallback_on_invalid_feed_values.xml'));
        $feed = $parser->execute();
        $this->assertEquals('https://en.wikipedia.org/wiki/Category:Russian-language_literature', $feed->getTitle());

        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_empty_channel.xml'));
        $feed = $parser->execute();
    ...
    public function testFindSiteUrl()
    {
        ...
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_extra.xml'), '', 'https://feeds.wikipedia.org/category/Russian-language_literature.xml'); // relative url
        $feed = $parser->execute();
    ...
    public function testFindItemId()
    {
        ...
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_empty_item.xml'));
        $feed = $parser->execute();
    ...
    public function testFindItemUrl()
    {
        ...
        // relative urls
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_extra.xml'), '', 'https://feeds.wikipedia.org/category/Russian-language_literature.xml');
        $feed = $parser->execute();
        ...
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_element_preference.xml'));
        $feed = $parser->execute();
    ...
    public function testFindItemTitle()
    {
        ...
        $parser = new Rss10(file_get_contents(__DIR__ . '/../fixtures/rss_10_fallback_on_invalid_item_values.xml'));
        $feed = $parser->execute();
